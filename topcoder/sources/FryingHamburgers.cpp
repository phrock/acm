...
{
    {
        FryingHamburgers theObject;
        eq(0, theObject.howLong(2, 3),15);
    }
    {
        FryingHamburgers theObject;
        eq(1, theObject.howLong(3, 4),15);
    }
    {
        FryingHamburgers theObject;
        eq(2, theObject.howLong(3, 2),10);
    }
    {
        FryingHamburgers theObject;
        eq(3, theObject.howLong(100, 0),0);
    }
    {
        FryingHamburgers theObject;
        eq(4, theObject.howLong(303, 919),35);
    }
}
////////////////////////////////////////////////////////////////////////////////
// END CUT HERE
