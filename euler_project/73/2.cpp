...
int fraction(int a1, int b1, int a2, int b2, int limit)
{
    int count = 0;
    if (b1+b2 > limit) return 0;
    count++;
    count += fraction(a1+a2, b1+b2, a2, b2, limit);
    count += fraction(a1, b1, a1+a2, b1+b2, limit);
