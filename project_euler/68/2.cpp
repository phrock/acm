...
void buildRing(vector< vector< vector<int> > >& result, int n, int l)
{
    int m = 2*n;
...
vector< vector< vector<int> > > letUsGo(int n)
{
    int m = 2*n;
...
int main()
{
    ...
    vector< vector< vector<int> > > result = letUsGo(n);
