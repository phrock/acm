...
string plural(string s)
{
    ...
    string ret;
    if (s1 == "x" || s1 == "s" || s1 == "o" || s2 == "ch")
	{ ret = s + "es"; return ret; }
    if (s1 == "f")
	{ ret = s.substr(0, n-1), ret += "ves"; return ret; }
    if (s2 == "fe")
	{ ret = s.substr(0, n-2), ret += "ves"; return ret; }
    if (s1 == "y")
	{ ret = s.substr(0, n-1), ret += "ies"; return ret; }
    ret = s + "s";
    return ret;
}
